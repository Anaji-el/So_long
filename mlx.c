...
/*   Updated: 2022/06/10 04:33:41 by anaji-el         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	mlx(char	**m)
{
	...
	v.player = mlx_xpm_file_to_image(v.mlx, "xmp/player.xpm", &v.width, &v.height);
	v.collect = mlx_xpm_file_to_image(v.mlx, "xmp/collect.xpm", &v.width, &v.height);
	v.close = mlx_xpm_file_to_image(v.mlx, "xmp/door_closed.xpm", &v.width, &v.height);
	v.m = m;
	v.count = 0;
	v.num = 0;
